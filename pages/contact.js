...
const Contact = () => {
    ...
    return (
        <>
            <Head>
                <title>Contact|Bazarrafal</title>
                <meta
                    name="description"
            ...
            <div className="flex justify-center items-center w-screen bg-white">
                <div className="mx-auto grid max-w-screen-2xl grid-cols-1 md:container md:mx-auto md:my-4 md:px-4 md:lg:px-20">
                    <div className="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="my-2 w-1/2 lg:w-1/4">
                                <button className="uppercase text-sm font-bold tracking-wide bg-[#f80506] text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
                                    Envoyez
                                </button>
                            </div>
                        </form>
                    ...
                    <div
                        className="w-full lg:-mt-96 lg:w-2/6 px-8 py-12 md:ml-auto bg-[#f80506]/[0.8] rounded-2xl">
                        <div className="flex flex-col text-white">
                            <h1 className="font-bold uppercase text-4xl my-4">Qui sommes nous</h1>
                            <p className="text-white">Bazarrafal se positionne comme un acteur numérique, économique, sociétal, innovant, avec toujours le même objectif : faciliter tous les échanges au quotidien de l’ensemble de nos utilisateurs..</p>
